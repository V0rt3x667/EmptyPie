...
rp_module_desc="Provides Joystick To Keyboard Conversion For Navigation Of EmptyPie Dialog Menus"
rp_module_section="core"

function _update_hook_joy2key() {
    # Make sure joy2key is always updated when updating emptypie-setup
